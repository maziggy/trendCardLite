class TrendCardLite extends HTMLElement {
        ...
        root.innerHTML = `
            <style>
                .main-container {
                    ...
                    border-radius: 10px;
                    padding: 12px; /* Increase padding to allow centering */
                ...
                .trend-cards {
                    display: flex;
                    justify-content: space-around; /* Ensure equal spacing between buttons */
                    width: 100%;
                    gap: 5px;
                }
                ...
                .trend-card {
                    ...
                    display: flex;
                    align-items: center;
                    justify-content: center; /* Center content in each card */
                    text-align: center;
                    flex: 1;
                    min-width: 90px;
                    color: #d0d0d0;
    ...
    createMetricCards() {
        ...
        const metrics = [
            { id: 'temp', configKey: 'temperature_delta', label: 'Temp', iconId: 'temp-icon', deltaId: 'temp-delta', labelId: 'temp-label' },
            { id: 'vpd', configKey: 'vpd_delta', label: 'VPD', iconId: 'vpd-icon', deltaId: 'vpd-delta', labelId: 'vpd-label' },
            { id: 'hum', configKey: 'humidity_delta', label: 'Hum', iconId: 'hum-icon', deltaId: 'hum-delta', labelId: 'hum-label' }
        ];
    ...
    set hass(hass) {
        ...
        // Update only the elements that are configured and available
