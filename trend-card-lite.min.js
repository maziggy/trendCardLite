        ...
        return `
            <div class="trend-card" id="${metricId}-card">
                ...
                <div class="trend-indicator" id="${metricId}-indicator">
                    <svg class="indicator-down indicator-dimmed" id="${metricId}-down" width="16" height="16" viewBox="0 0 24 24"><path fill="#498bff" d="M12 16l-6-6h12z"/></svg>
                    <svg class="indicator-equal indicator-dimmed" id="${metricId}-equal" width="16" height="16" viewBox="0 0 24 24"><path fill="#4ff24b" d="M5 11h14v2H5z"/></svg>
                    <svg class="indicator-up indicator-dimmed" id="${metricId}-up" width="16" height="16" viewBox="0 0 24 24"><path fill="#ff4c4c" d="M12 8l6 6H6z"/></svg>
                </div>
            </div>
        `;
    }
